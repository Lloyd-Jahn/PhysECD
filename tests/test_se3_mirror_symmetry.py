...
def test_se3_backbone():
    ...
    mu_total_vel = outputs['mu_total_vel']  # [2, 5, 3] 跃迁速度电偶极矩
    ...
    for state in range(5):
        ...
        print(f"  速度电偶极矩 x 分量: μ1_vel_x = {mu1_vel[0]:+.6f}, μ2_vel_x = {mu2_vel[0]:+.6f}")
        print(f"  速度电偶极矩 y 分量: μ1_vel_y = {mu1_vel[1]:+.6f}, μ2_vel_y = {mu2_vel[1]:+.6f}")
        print(f"  速度电偶极矩 z 分量: μ1_vel_z = {mu1_vel[2]:+.6f}, μ2_vel_z = {mu2_vel[2]:+.6f}")
    ...
    print("=" * 80)
    print("- 速度电偶极矩 (μ_vel): x 分量变号, y 和 z 分量不变")
    print("  即: μ_vel_2 = (-μ_vel_1_x, μ_vel_1_y, μ_vel_1_z)")
